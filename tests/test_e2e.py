...
class TestE2EWorkflow:
    ...
    def setup_and_teardown(self):
        ...
        if not is_gh_authenticated():
            pytest.skip("gh CLI is not authenticated. Run 'gh auth login' to authenticate.")
    ...
    def test_e2e_set_and_get_secrets(self, e2e_test_env_file, e2e_output_env_file):
        ...
        expected_secrets = {"E2E_TEST_SECRET_1", "E2E_TEST_SECRET_2", "E2E_TEST_SECRET_3"}
